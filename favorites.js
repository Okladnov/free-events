...
let currentUser = null; // Оставляем для функции removeFromFavorites
...
// =================================================================
async function main() {
    // [УЛУЧШЕНИЕ 2] Используем прямой, надежный способ получения сессии
    ...
    // Запускаем загрузку, если пользователь вошел
    if (currentUser) {
